---
name: analysis
description: Use when you need to analyze requirements, assess code state, or evaluate context — runs Analyst then PM to produce product-brief.md and PRD.md without architecture or execution steps. Trigger phrases — "analyze requirements", "assess", "evaluate context", "investigate requirements", "what should we build", "what do we need", "scope this", "discovery", "requirements".
---
...
> To implement end-to-end (includes planning), run `/multi-agent`.
