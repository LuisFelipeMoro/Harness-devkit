---
name: architecture
description: Use when designing architecture for a domain or feature outside the full multi-agent pipeline. Produces tech stack, security architecture, component design, ADRs, and Mermaid data-flow diagram. Trigger phrases — "architect", "design the system", "how should we structure", "system design", "component design", "data flow", "high-level design", "X or Y for structure".
---
...
Section templates: [references/sections.md](references/sections.md).
